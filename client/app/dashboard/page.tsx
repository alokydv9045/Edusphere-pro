      ...
      {isAdminOrPrincipal && (
        <div className="space-y-12">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <RealtimeChart title="Admission Activity" endpoint="/dashboard/stats" socketEvent="STUDENT_REGISTERED" type="area" xAxisKey="name" dataKey="count" color="#10b981" description="Registration funnel by class" />
